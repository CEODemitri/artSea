...
>
	<div class="px-6 py-3">
		...
		/>
		<h3 class="mt-4 text-lg font-semibold">Welcome to my journey.</h3>
		<p class="mt-2 text-sm text-gray-500">
			To stay up to date with our vision/roadmap, use the button below for a calendar view of
			special dates.
		</p>
		<button
